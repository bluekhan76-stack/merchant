          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
              <button
                ...
                className="rounded-xl border px-3 py-2 text-[13px] font-medium hover:bg-slate-50"
              >
                취소
              </button>
              <button
                ...
                className="rounded-xl bg-slate-900 px-3 py-2 text-[13px] font-medium text-white shadow-sm hover:opacity-90"
              >
                확인 후 링크 발송
              </button>
            </div>
          ...
          <form onSubmit={handleOpenConfirm} className="rounded-2xl bg-white p-3 shadow-sm ring-1 ring-slate-200 sm:p-4">
            ...
            <div className="grid gap-2">
              <div className="grid gap-2 lg:grid-cols-2">
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-2 py-1.5">
                  <div className="flex items-center gap-2">
                    <label className="w-16 shrink-0 text-[12px] font-medium text-slate-700">방문자 이름</label>
                    <input
                      value={form.visitorName}
                      onChange={(e) => handleChange("visitorName", e.target.value)}
                      className="min-w-0 flex-1 rounded-lg border bg-white px-2 py-1.5 text-[13px] outline-none transition focus:border-slate-400"
                      placeholder="예: 김민수"
                    />
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-2 py-1.5">
                  <div className="flex items-center gap-2">
                    <label className="w-16 shrink-0 text-[12px] font-medium text-slate-700">전화번호</label>
                    <input
                      value={form.phone}
              ...
              <div className="grid gap-2 lg:grid-cols-[1fr_1fr_auto]">
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-2 py-1.5">
                  <div className="flex items-center gap-2">
                    <label className="w-16 shrink-0 text-[12px] font-medium text-slate-700">유효시간</label>
                    <select
                      value={form.durationMinutes}
                      onChange={(e) => handleChange("durationMinutes", e.target.value)}
                      className="min-w-0 flex-1 rounded-lg border bg-white px-2 py-1.5 text-[13px] outline-none focus:border-slate-400"
                    >
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-2 py-1.5">
                  <div className="flex items-center gap-2">
                    <label className="w-16 shrink-0 text-[12px] font-medium text-slate-700">사용 횟수</label>
                    <input
                      type="number"
                      min="1"
                      ...
                      className="min-w-0 w-16 rounded-lg border bg-white px-2 py-1.5 text-[13px] outline-none focus:border-slate-400"
                    />
                    <span className="text-[11px] text-slate-500">최대 {remainingPasses}회</span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="rounded-xl border px-2.5 py-1.5 text-[12px] font-medium hover:bg-slate-50"
                >
                  현재 기준 적용
                </button>
              </div>
              ...
              <div className="grid gap-2 lg:grid-cols-2">
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-2 py-1.5">
                  <div className="flex items-center gap-2">
                    <label className="w-16 shrink-0 text-[12px] font-medium text-slate-700">시작일시</label>
                    <input
                      type="datetime-local"
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 px-2 py-1.5">
                  <div className="flex items-center gap-2">
                    <label className="w-16 shrink-0 text-[12px] font-medium text-slate-700">종료일시</label>
                    <input
                      type="datetime-local"
              ...
              <p className="text-[11px] text-slate-500">
                유효시간은 방문자가 실제로 주차권을 사용한 시점부터 적용됩니다. 시작/종료일시를 직접 수정하지 않았다면 유효시간 선택 시 현재 시각 기준으로 자동 반영됩니다.
              </p>
            </div>
            ...
            <div className="mt-2 rounded-xl border p-2.5">
              <div className="mb-2 flex items-center justify-between gap-2">
                ...
                <span className="text-[11px] text-slate-500">1개 이상 선택</span>
              </div>
              ...
              <div className="grid gap-1.5">
                ...
                >
                  ...
                  />
                  <span className="min-w-0 flex-1 text-[13px] font-medium">모든 차단기</span>
                ...
                <div className="grid grid-cols-2 gap-1.5 sm:grid-cols-4">
                  {merchant.parkingGates.map((barrier) => {
                    ...
                    return (
                      <label
                        key={barrier.id}
                        className={`flex cursor-pointer items-center justify-center gap-1 rounded-xl border px-2 py-2 text-center transition ${
                      ...
                      >
                        <input
                          ...
                          className="h-3.5 w-3.5 shrink-0"
                        />
                        <span className="text-[12px] font-medium leading-none">{barrier.name}</span>
                      </label>
                    );
                  })}
                </div>
              ...
              <div className="mt-2 rounded-xl bg-slate-50 px-2.5 py-2 text-[12px] text-slate-600">
            ...
            <div className="mt-2">
              <label className="mb-1 block text-[12px] font-medium">메모</label>
              <textarea
                value={form.memo}
                onChange={(e) => handleChange("memo", e.target.value)}
                className="min-h-16 w-full rounded-xl border bg-white px-2 py-1.5 text-[13px] outline-none focus:border-slate-400"
