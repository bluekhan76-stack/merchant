        ...
        <section className="space-y-3 lg:col-span-8">
          <form onSubmit={handleOpenConfirm} className="rounded-2xl bg-white p-3 shadow-sm ring-1 ring-slate-200 sm:p-4">
            ...
            <div className="mt-1.5 rounded-lg border p-2">
              ...
              <div className="mt-1.5 rounded-lg bg-slate-50 px-2 py-1.5 text-[11px] text-slate-600">
            ...
            <div className="mt-1.5">
              <label className="mb-0.5 block text-[11px] font-medium">메모</label>
              <textarea
                value={form.memo}
                onChange={(e) => handleChange("memo", e.target.value)}
                className="min-h-12 w-full rounded-lg border bg-white px-2 py-1 text-[12px] outline-none focus:border-slate-400"
