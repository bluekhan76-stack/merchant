            ...
            <div className="grid gap-3">
              <div className="grid gap-3 lg:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2.5">
                  <div className="flex items-center gap-3">
                    <label className="w-20 shrink-0 text-sm font-medium text-slate-700">방문자 이름</label>
                    <input
                      value={form.visitorName}
                      onChange={(e) => handleChange("visitorName", e.target.value)}
                      className="min-w-0 flex-1 rounded-xl border bg-white px-3 py-2.5 text-sm outline-none transition focus:border-slate-400"
                      placeholder="예: 김민수"
                    />
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2.5">
                  <div className="flex items-center gap-3">
                    <label className="w-20 shrink-0 text-sm font-medium text-slate-700">전화번호</label>
                    <input
                      value={form.phone}
              ...
              <div className="grid gap-3 lg:grid-cols-[1fr_1fr_auto]">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2.5">
                  <div className="flex items-center gap-3">
                    <label className="w-20 shrink-0 text-sm font-medium text-slate-700">유효시간</label>
                    <select
                      value={form.durationMinutes}
                      onChange={(e) => handleChange("durationMinutes", e.target.value)}
                      className="min-w-0 flex-1 rounded-xl border bg-white px-3 py-2.5 text-sm outline-none focus:border-slate-400"
                    >
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2.5">
                  <div className="flex items-center gap-3">
                    <label className="w-20 shrink-0 text-sm font-medium text-slate-700">사용 횟수</label>
                    <input
                      type="number"
                      min="1"
                      ...
                      className="min-w-0 w-24 rounded-xl border bg-white px-3 py-2.5 text-sm outline-none focus:border-slate-400"
                    />
                    <span className="text-xs text-slate-500">최대 {remainingPasses}회</span>
                  </div>
                </div>
              ...
              <div className="grid gap-3 lg:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2.5">
                  <div className="flex items-center gap-3">
                    <label className="w-20 shrink-0 text-sm font-medium text-slate-700">시작일시</label>
                    <input
                      type="datetime-local"
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2.5">
                  <div className="flex items-center gap-3">
                    <label className="w-20 shrink-0 text-sm font-medium text-slate-700">종료일시</label>
                    <input
                      type="datetime-local"
