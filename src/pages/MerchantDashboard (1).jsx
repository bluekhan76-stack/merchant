    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <header className="sticky top-0 z-20 border-b bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <span className="whitespace-nowrap text-sm font-semibold text-slate-700 sm:text-base">
      ...
      <main className="mx-auto grid max-w-7xl gap-3 px-3 py-3 sm:px-4 lg:grid-cols-12 lg:px-6">
        ...
        <aside className="space-y-6 lg:col-span-4">
          ...
          <div className="flex min-h-[176px] flex-col items-center justify-center rounded-2xl bg-white px-4 py-5 text-center shadow-sm ring-1 ring-slate-200 lg:min-h-[178px]">
